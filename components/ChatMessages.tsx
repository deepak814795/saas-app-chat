      ...
      <div className="p-5">
        {!loading && messages?.length===0 && (
          ...
          space-y-2 bg-indigo-400 text-white font-extralight">
            ...
            <h2>
              <span className="font-bold text-black" style={{fontSize: '1.5rem'}}>Invite a friend </span><span className="text-black" style={{fontSize: '1.5rem'}}>&</span>{" "}
              <span className="font-bold text-black" style={{fontSize: '1.5rem'}}>Send your first message in ANY Language</span>{" "}
               <span className="text-black" style={{fontSize: '1.5rem'}}>below to get started!</span>
            </h2>
